const data = {
  ...
  portfolio:[
    ...
    },
    {
      ...
      descriptionEn: "This is a 2.5D two-player cooperative game made with Unity3D. In this project, I was responsible for program and algorithm design, game logic, and model making. The game refers to the gameplay of Among Us and Overcooked. Players need to complete the assigned work within a limited time to test the player's ability to divide labor. For this game, I designed an algorithm to generate random maps so that players can play a unique and non-repeating game every time.<br><br>*This is an exhibit of SIG Playful Media Showcase 2022 and 2022 Digital Entertainment Leadership Forum",
    ...
    },
    {
      ...
      descriptionEn: "Field Of Honour is a two-player competitive card game made with Unreal Engine 4. The biggest feature of the game is that each card has a model to represent it. I was in charge of game design, game logic, model making, API, and database design. It was also my first project developed with Unreal Engine.",
    ...
    {
      title: "Poker Inquiry",
      descriptionEn: "This program is for personal use, to check the hand range of Texas Hold'em. I often use this app when playing Texas Hold'em to reduce the tedious query work. After using this program, the speed of learning Texas Hold'em has increased.",
    ...
    {
      title: "Discord Bot",
      descriptionEn: "Discord Bot is a one-man program for the Discord server, this bot provides some useful tools such as randomizing teams, and helping decision-making. The bot also automatically calculates server statistics. In addition, users can also use this bot to query the current real-time weather conditions provided by Hong Kong Observatory.",
    ...
    {
      title: "Wordle Online",
      descriptionEn: "Wordle, the word game that took the world by storm, also fascinated me. But the original game does not offer simultaneous play, and the number of plays per day is limited. I developed a Windows application version of Wordle to play with friends. In this version of the game, players can play the same word at the same time, and other players will see the progress of other players in real-time for added excitement.",
    ...
    },
    {
      ...
      links: {
        ...
        sites: [{name: "Google Play", url: "https://play.google.com/store/apps/details?id=com.MartinL.AlphabetMahjongSpanish" }],
      }
    },
  ]
}
...
const addPortfolio = function(project, isPreviewFirst = false){
  ...
  let githubHTML = "";
  project.links.github && (githubHTML += 
